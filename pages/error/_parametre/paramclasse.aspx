          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body pad table-responsive">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="classe" runat="server" required />
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary card-outline">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-list"></i> Liste des Classes</h3>
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                <i class="fas fa-minus"></i>
              </button>
...
<script src="js/classeload.js"></script>
<script src="../../dist/js/sweetalert2@11.js"></script>
<script src="js/classedelete.js"></script>
<script src="../../dist/js/sweetalert.js"></script>
<script src="js/classeajouter.js"></script>
