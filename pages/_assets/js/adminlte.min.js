...
const fullUrl = "http://localhost:8089/auth/Login.aspx";

// Supprimer la dernière partie après le dernier "/"
const shortUrl = fullUrl.substring(0, fullUrl.lastIndexOf('/') + 1);

console.log(shortUrl);  // Affiche : http://localhost:8089/auth/
