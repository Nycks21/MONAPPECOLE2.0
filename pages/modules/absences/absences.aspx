                            ...
                            <section class="content">
                                <div class="container-fluid">
                                    ...
                                    <div class="tab-container">
                                        <button type="button" class="tab-btn active" onclick="switchTab('absences')">📅
                                            Absences</button>
                                        <button type="button" class="tab-btn" onclick="switchTab('retards')">⏰
                                            Retards</button>
                                    </div>
                                    ...
                                    <div id="tab-absences" class="tab-content active">
                                        <div class="dash-card">
                                            <div class="dash-card-head">
                                                <span class="dash-card-title"><i class="fas fa-calendar-times"></i>
                                                    Gestion des absences</span>
                                                <button type="button" class="btn btn-success btn-sm"
                                                    onclick="openAbsenceModal()"><i class="fas fa-plus"></i> Signaler
                                                    une absence</button>
                                            </div>
                                            <div class="dash-card-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="dash-table">
                                                        <thead>
                                                            <tr>
                                                                <th style="min-width: 100px; text-align: left;">Élève
                                                                </th>
                                                                <th style="min-width: 80px; text-align: left;">Classe
                                                                </th>
                                                                <th style="min-width: 100px; text-align: left;">Date
                                                                    début</th>
                                                                <th style="min-width: 100px; text-align: left;">Date fin
                                                                </th>
                                                                <th style="min-width: 60px; text-align: left;">Durée
                                                                </th>
                                                                <th style="min-width: 80px; text-align: left;">Justifiée
                                                                </th>
                                                                <th style="min-width: 150px; text-align: left;">Motif
                                                                </th>
                                                                <th style="min-width: 100px; text-align: left;">Actions
                                                                </th>
                                                            </tr>
                                                        </thead>
                                    ...
                                    <div id="tab-retards" class="tab-content">
                                        <div class="dash-card">
                                            <div class="dash-card-head">
                                                <span class="dash-card-title"><i class="fas fa-clock"></i> Gestion des
                                                    retards</span>
                                                <button type="button" class="btn btn-success btn-sm"
                                                    onclick="openRetardModal()"><i class="fas fa-plus"></i> Signaler un
                                                    retard</button>
                                            </div>
                                            <div class="dash-card-body">
                                                ...
                                                <div class="absence-stats" id="retardStatsContainer">
                                                    ...
                                                    <div class="absence-card">
                                                        <div class="stat-icon"><i class="fas fa-chart-line"
                                                    ...
                                                    <table class="dash-table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="min-width: 90px; text-align: left;">Heure
                                                                    arrivée</th>
                                                                <th style="min-width: 90px; text-align: left;">Heure
                                                                    prévue</th>
                                                                <th style="min-width: 60px; text-align: left;">Durée
                                                                </th>
                                                                <th style="min-width: 80px; text-align: left;">Justifié
                                                                </th>
                                                                <th style="min-width: 150px; text-align: left;">Motif
                                                                </th>
                                                                <th style="min-width: 100px; text-align: left;">Actions
            ...
            <div id="absenceModal" class="modal">
                <div class="modal-content" style="max-width:600px;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><label>Date début *</label><input type="date"
                                        id="absenceDateDebut" class="form-control"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label>Date fin *</label><input type="date" id="absenceDateFin"
                                        class="form-control"></div>
                            </div>
                        </div>
                        <div class="form-group"><label>Motif</label><textarea id="absenceMotif" class="form-control"
                                rows="3"></textarea></div>
                        <div class="form-group"><label><input type="checkbox" id="absenceJustifie"> Justifiée</label>
                        </div>
                        <div id="absenceJustificationGroup" style="display:none;">
                            <div class="form-group"><label>Justification</label><textarea id="absenceJustification"
                                    class="form-control" rows="2"></textarea></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="saveAbsence()"><i
            ...
            <div id="retardModal" class="modal">
                <div class="modal-content" style="max-width:600px;">
                    <div class="modal-header">
                        ...
                        <button type="button" onclick="closeRetardModal()"
                            style="background:none; border:none; font-size:24px; cursor:pointer;">&times;</button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                        ...
                        <div class="form-group"><label>Date *</label><input type="date" id="retardDate"
                                class="form-control"></div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><label>Heure prévue *</label><input type="time"
                                        id="retardHeurePrevue" class="form-control"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label>Heure arrivée *</label><input type="time"
                                        id="retardHeureArrivee" class="form-control"></div>
                            </div>
                        </div>
                        <div class="form-group"><label>Motif</label><textarea id="retardMotif" class="form-control"
                                rows="3"></textarea></div>
                        <div class="form-group"><label><input type="checkbox" id="retardJustifie"> Justifié</label>
                        </div>
                        <div id="retardJustificationGroup" style="display:none;">
                            <div class="form-group"><label>Justification</label><textarea id="retardJustification"
                                    class="form-control" rows="2"></textarea></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="saveRetard()"><i class="fas fa-save"></i>
                            Enregistrer</button>
