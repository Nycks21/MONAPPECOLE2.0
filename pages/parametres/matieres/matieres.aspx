                    ...
                    <nav>
                        <ul class="nav-pills">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="../classes/classes.aspx" class="nav-link">
                                    <div style="width:30px;text-align:center;margin-right:10px;">
                            ...
                            <li class="nav-item">
                                <a href="matieres.aspx" class="nav-link active">
                                    <div style="width:30px;text-align:center;margin-right:10px;">
                    ...
                    <div class="dash-card">
                        <div class="dash-card-head">
                            ...
                            <div class="action-buttons">
                                <button type="button" class="btn btn-success btn-sm" onclick="openAddMatiereModal()">
        ...
        <div id="addMatiereModal" class="modal" role="dialog" aria-modal="true" aria-labelledby="matiereModalTitle">
            <div class="modal-content" style="max-width:550px;">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close-modal" onclick="closeAddMatiereModal()" aria-label="Fermer">&times;</button>
                </div>
                <div class="modal-body">
                    <input type="hidden" id="matiereEditNom">
                    <div class="form-group">
                        <label for="matiereNom">Nom de la matière *</label>
                        <input type="text" id="matiereNom" class="form-control" placeholder="Ex: Mathématiques" maxlength="100">
                    </div>
                    <div class="form-group">
                        <label for="matiereEnseignant">Enseignant responsable *</label>
                        <input type="text" id="matiereEnseignant" class="form-control" placeholder="Ex: M. RAKOTO" maxlength="100">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
