<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" %>
    ...
    <body class="hold-transition login-page">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form id="form1" runat="server">
                        ...
                        <asp:Label ID="lblLicenceInfo" runat="server" ForeColor="Red" CssClass="mb-2 d-block"
                            Font-Bold="true"></asp:Label>
                        <asp:Label ID="lblUserLimitInfo" runat="server" ForeColor="Red" CssClass="mb-2 d-block"
                            Font-Bold="true"></asp:Label>
                        ...
                        <div class="input-group mb-3">
                            <asp:TextBox ID="txtUsername" CssClass="form-control" runat="server"
                                Placeholder="Nom d'utilisateur"></asp:TextBox>
                        ...
                        <div class="input-group mb-3">
                            <asp:TextBox ID="txtPassword" CssClass="form-control" runat="server" TextMode="Password"
                                Placeholder="Mot de passe"></asp:TextBox>
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <asp:Button ID="btnLogin" CssClass="btn btn-primary btn-block" runat="server"
                                    Text="Valide" OnClick="btnLogin_Click" />
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <!-- Dans Login.aspx, après le chargement des scripts -->
        <script>
            // Démarrer le vérificateur de blocage immédiatement
